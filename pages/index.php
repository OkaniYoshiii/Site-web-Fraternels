...
<head>
    ...
    <meta name="description" content="Page d'accueil du serveur 7 Days to Die &quot;Les Fraternels&quot;">
        ...
        <section>
            <div class="medium mods-intro">
                <div>
                    ...
                    <!-- <a class="fake-button" href="">En savoir plus</a> -->
                </div>
                <div>
            ...
            <div class="wide mods-preview">
                ...
                <div class="wide mods-images">
                    <div>
                        <a href="mod-difficulty.php" class="legend">
                    ...
                    <div>
                        <a href="mod-compagnon.php" class="legend">
                    ...
                    <div>
                        <a href="mod-elecfrt.php" class="legend">
